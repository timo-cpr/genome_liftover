...
eg.    
python genome_liftover.py --infile mydata/nature_paper/gwas_summary.tsv --outfile /mydata/first_paper/results --idxCHR 1 --idxBP 2 --liftover hg38ToHg19.over.chain.gz     
